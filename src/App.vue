          ...
          <tr>
            <th>
              ...
              <input
                ...
                value="-100"
                size="4"
                v-on:click="$refs.sled.moveX(-100)"
              />
              <input
                type="button"
                value="-25"
                size="4"
                v-on:click="$refs.sled.moveX(-25)"
              />
              <input
                type="button"
                value="-1"
                size="4"
                v-on:click="$refs.sled.moveX(-1)"
              />
              <input
                type="button"
                value="+1"
              ...
              <input
                type="button"
                value="-100"
                v-on:click="$refs.sled.moveY(-100)"
              />
              <input
                type="button"
                value="-25"
                v-on:click="$refs.sled.moveY(-25)"
              />
              <input
                type="button"
                value="-1"
                v-on:click="$refs.sled.moveY(-1)"
              />
              <input
                type="button"
                value="+1"
            ...
            >
              <input
                type="button"
                value="-100"
                v-on:click="$refs.sled.moveV(index, -100)"
              />
              <input
                type="button"
                value="-25"
                v-on:click="$refs.sled.moveV(index, -25)"
              />
              <input
                type="button"
                value="-1"
                v-on:click="$refs.sled.moveV(index, -1)"
              />
              <input
                type="button"
                value="X"
          ...
          >
            <td>
              <input
                type="button"
                value="-100"
                v-on:click="$refs.sled.moveH(hindex, -100)"
              />
              <input
                type="button"
                value="-25"
                v-on:click="$refs.sled.moveH(hindex, -25)"
              />
              <input
                type="button"
                value="-1"
                v-on:click="$refs.sled.moveH(hindex, -1)"
              />
              <input
                type="button"
                value="X"
