...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"135f0336-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/cell.vue?vue&type=template&id=39c816bc&
var cellvue_type_template_id_39c816bc_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{style:(_vm.style)},[(_vm.cell['textfield'])?_c('span',{staticClass:"cell-textfield",staticStyle:{"position":"absolute","top":"4px%","background-color":"#FFF","border-radius":"3px","padding":"4px","opacity":"0.9"},domProps:{"innerHTML":_vm._s(_vm.cell.textfield)}}):_vm._e(),(!_vm.checked)?_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.cell.metadata),expression:"cell.metadata"}],staticClass:"cell-select",staticStyle:{"position":"absolute","top":"50%","left":"50%","transform":"translate(-50%, -50%)"},attrs:{"disabled":_vm.locked},on:{"change":[function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.$set(_vm.cell, "metadata", $event.target.multiple ? $$selectedVal : $$selectedVal[0])},function($event){return _vm.$emit('onChange', _vm.cell)}]}},[_c('option',{attrs:{"value":"none"}},[_vm._v("\n      None\n    ")]),_vm._l((_vm.metadata),function(value,key){return _c('option',{key:key,domProps:{"value":key}},[_vm._v("\n      "+_vm._s(value)+"\n    ")])})],2):_vm._e(),_c('input',{staticClass:"cell-checkbox",staticStyle:{"position":"absolute","right":"10px","bottom":"10px"},attrs:{"disabled":_vm.locked,"type":"checkbox"},domProps:{"value":_vm.checked},on:{"click":_vm.setChecked}})])}
var cellvue_type_template_id_39c816bc_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/cell.vue?vue&type=template&id=39c816bc&
...
var cell_component = normalizeComponent(
  ...
  cellvue_type_template_id_39c816bc_render,
  cellvue_type_template_id_39c816bc_staticRenderFns,
  false,
  null,
  null,
  null
